...
class TestHfTokenizer(unittest.TestCase):
    ...
    def test_llama3_2_1b_special_toks(self) -> None:
        ...
        bos_id = tokenizer.convert_tokens_to_ids(tokenizer.special_tokens_map['bos_token'])
        eos_id = tokenizer.convert_tokens_to_ids(tokenizer.special_tokens_map['eos_token'])
